...
//import { User } from "../../../../helper/util";
import './ficha-pastoral.css';
import PastorFormItem from "./pastor-form-item";

const FichaPastoralAdd = () => {

  const navigate = useNavigate();
  const token = JSON.parse(localStorage.getItem('userDetails'))
  const { register, clearErrors, setValue, handleSubmit, getValues, watch, trigger, reset, formState: { isValid, errors } } = useForm({
      //resolver:User,
      defaultValues: {
          form_usuario: "",
          form_nombres: "",
...
export default FichaPastoralAdd;
